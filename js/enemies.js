class Enemy {
    ...
    draw(context) {
        ...
        // context.beginPath();
        // context.arc(this.position.x + this.width/3.5, this.position.y + this.height/1.2, this.width/6, 0, Math.PI * 2);
        // context.stroke();
    }
...
export class Demon {
    constructor(game) {
        ...
        this.demonEnemies = [new Enemy(this.game, this.width, this.height, this.image, {x:600, y:200}, this.maxFrame, this.fps)];
    }
    update(input, deltaTime) {
    ...
    init() {
        this.demonEnemies = [new Enemy(this.game, this.width, this.height, this.image, {x:600, y:200}, this.maxFrame)];
    }
}
...
export class FireSkull {
    constructor(game) {
        ...
        this.fireSkullEnemies = [new Enemy(this.game, this.width, this.height, this.image, {x:300, y:200}, this.maxFrame, this.fps)];
    }
    update(input, deltaTime) {
...
export class Ghost{
    constructor(game) {
        ...
        this.ghostEnemies = [new Enemy(this.game, this.width, this.height, this.image, {x:300, y:200}, this.maxFrame, this.fps)];
    }
    update(input, deltaTime) {
...
export class HellHound {
    constructor(game) {
        ...
        this.width = 66;
        this.height = 32;
        this.image = './../img/enemies/Hell-Hound-Files/hell-hound-run.png';
        this.maxFrame = 4;
        this.fps = 16;

        this.hellHoundEnemies = [new Enemy(this.game, this.width, this.height, this.image, {x:300, y:350}, this.maxFrame, this.fps)];
    }
    update(input, deltaTime) {
...
export class Nightmare {
    constructor(game) {
        ...
        this.nightmareEnemies = [new Enemy(this.game, this.width, this.height, this.image, {x:300, y:280}, this.maxFrame, this.fps)];
    }
    update(input, deltaTime) {
